{{--
Partial: _variant-row.blade.php
...
<div class="vgroup-card" data-vcard>
    ...
    <div class="vgroup-body">
        ...
        {{-- Variant Image --}}
        <div class="form-grid form-grid" style="margin-bottom:12px">
            <div>
                ...
                <div class="w-full relative group" data-dropzone>
                    <label
                        class="relative flex flex-col items-center justify-center w-full py-4 px-4 border-2 border-dashed border-(--border2) rounded-xl bg-(--surface) hover:border-(--cyan) transition-all duration-300 cursor-pointer focus-within:ring-2 focus-within:ring-(--cyan) focus-within:ring-offset-2 overflow-hidden">
                        <div
                            class="absolute inset-0 bg-(--elevated) opacity-0 group-hover:opacity-40 transition-opacity duration-300">
                        </div>
                        <div
                            class="relative w-8 h-8 mb-2 rounded-full bg-(--surface) border border-(--border2) flex items-center justify-center text-(--cyan) shadow-sm group-hover:scale-110 transition-transform duration-300 z-10">
                        ...
                        <input type="file" name="variants[{{ $vIdx }}][image]" accept="image/*"
        ...
        <div class="form-grid form-grid-3" style="margin-top:14px">
            ...
            <div>
                ...
                <input type="text" name="variants[{{ $vIdx }}][sku]" value="{{ $variant['sku'] ?? '' }}"
                    placeholder="Auto-generated if blank" class="field-control">
            </div>
            <div>
