...
<main id="mn">
    ...
    <div class="page-head fu d0">
        <div>
            ...
            <p class="page-copy">Select which central products appear under the
                <strong>{{ $badge->text }}</strong> badge. Saving syncs changes to all tenants automatically.
            </p>
        </div>
    ...
    <div class="g-stats4 section-gap">
        <div class="card card-glow-cyan">
            ...
            <p class="stat-sub">Products currently selected for the <em>{{ $badge->text }}</em> badge.</p>
        </div>
...
<script>
(function () {
    const SEARCH_URL  = @json(route('admin.badges.search', $badge));
    ...
    btnSave.addEventListener('click', async () => {
        ...
        btnSave.textContent = 'Saving & syncing…';
