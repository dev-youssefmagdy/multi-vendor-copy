...
(function () {
    ...
    function buildVariantRow(vIdx) {
        var thumbHtml = '<label class="vrow-thumb-placeholder" style="cursor:pointer">'
            + '<span>IMG</span>'
        ...
        return '<div class="vrow" data-vcard>'
            ...
            + '<line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/>'
            + '</svg></button>'
            + '<input type="number" step="0.01" min="0" name="variants[' + vIdx + '][price]" value="" class="field-control" style="max-width:90px" placeholder="Price">'
            + '<input type="number" min="0" step="1" name="variants[' + vIdx + '][stock]" value="0" class="field-control" style="max-width:80px" placeholder="Stock">'
            + '<input type="text" name="variants[' + vIdx + '][sku]" value="" placeholder="Auto-generated if blank" class="field-control" style="max-width:110px">'
            + '<input type="number" min="0" step="1" name="variants[' + vIdx + '][weight_grams]" value="" placeholder="0" class="field-control" style="max-width:90px">'
            + '<label class="toggle-field" style="flex-shrink:0"><input type="hidden" name="variants[' + vIdx + '][active]" value="0">'
            + '<input type="checkbox" name="variants[' + vIdx + '][active]" value="1" checked><span>Active</span></label>'
            + '</div>'
