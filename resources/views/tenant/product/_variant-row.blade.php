{{--
Partial: tenant/product/_variant-row.blade.php (compact row layout)
                    ...
                    <div class="var-options" style="display:flex;gap:4px;align-items:center">
                        ...
                        @if ($pIdx > 0)
                            <button type="button" class="btn btn-secondary btn-sm btn-danger"
                                onclick="removeOptionPair(this)" title="Remove this group" style="padding:4px 6px">
