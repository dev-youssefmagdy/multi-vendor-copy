  ...
  <section class="auth-card card">
    ...
    <div class="auth-panel">
      ...
      <div class="auth-divider">
        <span></span>
        <em>{{ __('or continue with') }}</em>
        <span></span>
      </div>

      <div class="auth-social">
        <a href="{{ route('website.social.google', 'login') }}" class="btn btn-social">
        ...
        <a href="{{ route('website.social.apple', 'login') }}" class="btn btn-social btn-social-apple">
