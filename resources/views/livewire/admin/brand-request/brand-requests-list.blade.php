<main id="mn">
    <div class="page-head fu d0">
        <div>
            ...
            <p class="page-copy">Review and manage tenant brand requests with status tracking and notifications.</p>
        </div>
    </div>
    ...
    <div class="g-stats4 section-gap">
        <div class="card card-glow-cyan fu d1">
            ...
            <p class="panel-copy">All brand requests across tenants.</p>
        </div>
        ...
        <div class="card card-glow-violet fu d3">
            ...
            <p class="panel-copy">Approved brand requests.</p>
        </div>
    ...
    <details class="card filters-card fu d5 section-gap">
        <summary class="filters-summary">
            <div>
                ...
                <p class="panel-copy">Filter requests by tenant, title, or status.</p>
            </div>
        ...
        <div class="filters-grid">
            <div>
                <label class="field-label">Search Title</label>
                <x-input wire:model.live.debounce.300ms="search" placeholder="Search by title..." />
            </div>
            <div>
    ...
    <div class="card fu d6 table-card-shell">
        <div class="table-header-shell">
            <div>
                <h3 class="panel-title">Brand Requests</h3>
                <p class="panel-copy">All tenant brand requests sorted by latest.</p>
            </div>
        </div>

        <x-table :headers="['#', 'Tenant', 'Request', 'Status', 'Submitted', 'Actions']">
                ...
                <tr>
                    ...
                    <td>
                        <div class="table-actions-inline">
                            <a href="{{ route('admin.brand-requests.show', $request->id) }}" class="btn btn-secondary btn-sm"
                ...
                <tr>
                    <td colspan="6">
                        <div class="empty-state">
                            <div class="empty-state-title">No brand requests</div>
                    ...
                    <div style="display:flex;align-items:center;justify-content:space-between;gap:8px;flex-wrap:wrap;">
                        <div>
                            <div
                                ...
                                Request</div>
                            <div style="font-size:14px;font-weight:600;color:var(--t1);">{{ $selectedTitle }}</div>
                        </div>
