<main id="mn">
    <div class="page-head fu d0">
        <div>
            <div class="eyebrow">Commerce · Brand Requests</div>
            <h1 class="D page-title">Request #{{ $request->id }} — {{ $request->title }}</h1>
            <p class="page-copy">Review details, manage payment requests, and communicate with the vendor.</p>
        </div>
        <div class="page-actions">
            <a href="{{ route('admin.brand-requests.index') }}" class="btn btn-secondary">← Back to List</a>
        </div>
    </div>
    ...
    <div class="g-2col section-gap" style="display:grid;grid-template-columns:1fr 340px;gap:20px;align-items:start;">
        ...
        <div class="card fu d1" style="padding:24px;">
            ...
            <dl style="display:grid;grid-template-columns:140px 1fr;gap:10px 16px;font-size:13px;">
                ...
                <dt class="entity-subtitle">Title</dt>
                <dd class="entity-title">{{ $request->title }}</dd>
            ...
            <div class="locale-fields-group fu" style="margin:0 0 20px 0;">
                ...
                <div class="form-grid form-grid-2">
                    <div>
                        ...
                        <x-input wire:model.defer="paymentLabel" placeholder="e.g. Brand Licensing Fee, Trademark Review..." />
    ...
    <section class="card fu d4 section-gap" style="padding:0;overflow:hidden;">
        <div class="table-header-shell" style="padding:16px 20px;">
            <div>
                ...
                <p class="panel-copy">Chat with the vendor about this brand request.</p>
            </div>
        </div>
...
<script>
    if (window.Echo) {
        window.Echo.private('tenant.{{ $request->tenant_id }}.brand-requests.{{ $request->id }}')
