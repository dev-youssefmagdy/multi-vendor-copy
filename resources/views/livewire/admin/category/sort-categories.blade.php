<main id="mn">
    <div class="page-head fu d0">
        <div>
            ...
            <p class="page-copy">Drag rows to reorder how categories are exposed to tenants and the central storefront.</p>
        </div>
    ...
    <section class="card table-card-shell section-gap">
        <div class="table-header-shell">
            <div>
                ...
                <p class="panel-copy">{{ $categories->count() }} categories.</p>
            </div>
        </div>
        ...
        @else
            <div class="empty-state">
                <h3 class="panel-title">No categories</h3>
                <p class="panel-copy">Create categories before ordering them.</p>
            </div>
        @endif
    </section>
