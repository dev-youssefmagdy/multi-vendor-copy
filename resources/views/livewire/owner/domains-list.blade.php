<div>
    ...
    <div class="page-head">
        <div>
            <div class="page-title D">{{ __('Domains') }}</div>
            <div class="page-copy">{{ __('Manage your store domains and DNS connection status.') }}</div>
        </div>
        ...
        <div style="padding:18px 20px;">
            <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;flex-wrap:wrap;">
                ...
                <div style="display:flex;align-items:center;gap:8px;flex-shrink:0;">
                    ...
                    <button type="button"
                        wire:click="secretAdminLogin('{{ $tenant->id }}')"
                        wire:loading.attr="disabled"
                        wire:target="secretAdminLogin('{{ $tenant->id }}')"
                        title="{{ __('Open admin panel') }}"
                        class="btn btn-secondary btn-sm">
                        <span wire:loading.remove wire:target="secretAdminLogin('{{ $tenant->id }}')">
                        ...
                        <span wire:loading wire:target="secretAdminLogin('{{ $tenant->id }}')">…</span>
                        {{ __('Admin') }}
                    </button>
                </div>
            </div>
