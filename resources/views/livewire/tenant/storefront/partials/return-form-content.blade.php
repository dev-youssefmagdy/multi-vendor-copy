...
<div class="max-w-[720px] mx-auto px-4 sm:px-6 py-10">
    ...
    <form wire:submit.prevent="submit" class="bg-white border border-gray-200 rounded-2xl p-6 flex flex-col gap-5">
        <div>
            ...
            <select wire:model.live="reason" class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm">
        ...
        <div>
            ...
            <textarea wire:model.live.debounce.500ms="description" rows="4" class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm"
        ...
        <div>
            ...
            <input type="file" wire:model.live="photos" multiple accept="image/*" class="w-full text-sm">
        ...
        <div>
            ...
            <input type="file" wire:model.live="video" accept="video/*" class="w-full text-sm">
