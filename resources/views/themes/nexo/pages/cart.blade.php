...
<main class="flex-grow bg-white pt-3 lg:pt-6 pb-14 w-full" data-cart-rate="{{ $rate }}">
    <div class="max-w-[1280px] mx-auto px-4 lg:px-8">
        ...
        <div class="flex flex-col items-center justify-center py-20 text-center">
            <img loading="lazy" src="{{ asset('nexo/assets/images/empty-cart.svg') }}" alt="{{ __('Visa') }}" class="" />
        ...
        <div>
            ...
            @php
                $nexoPct = min(100, (int) round($cartWeight / $shippingThreshold * 100));
                $nexoRemaining = max(0, $shippingThreshold - $cartWeight);
            @endphp
            <div class="mb-4 lg:mb-10 block p-1 lg:p-0">
                <div
                                ...
                                <div class="text-[15px] leading-snug">
                                    ...
                                    @else
                                        ...
                                        <span class="text-[#555] ms-2">{{ __("You're") }}
                                            ...
                                            {{ __('away — add') }}
                                            <span class="font-semibold text-[#242424]">{{ number_format($nexoRemaining) }}{{ __('g') }}</span>
                                            {{ __('more to qualify') }}
                                        </span>
                                    @endif
                                </div>
                                <span class="ms-4 shrink-0 text-[12px] font-semibold text-[#FF4D00] bg-[#FF4D00]/10 px-3 py-0.5 rounded-full tabular-nums">{{ $nexoPct }}%</span>
                            </div>
                            <div class="h-2 bg-[#D9D9D9] rounded-full overflow-hidden">
                                <div class="h-full bg-[#FF4D00] rounded-full transition-all duration-500" style="width: {{ $nexoPct }}%"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="sm:hidden h-5 bg-[#D9D9D9] rounded-3xl mt-2">
                        <div class="h-full bg-[#FF4D00] rounded-3xl relative" style="width: {{ $nexoPct }}%">
                                ...
                                <div class="flex gap-4 flex-1 min-w-0">
                                    ...
                                    <div class="flex-1 min-w-0 lg:w-[560px] pt-2 pb-6 border-b border-[#C4C4C4] flex flex-col justify-between">
                                        ...
                                        <div class="flex flex-col gap-2">
                                            ...
                                            <div class="text-red-600 text-xs font-semibold flex items-center gap-1">
                    ...
                    <div class="relative overflow-hidden">
                        <div class="swiper product-slid-swiper w-full select-none">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    @include('themes.nexo.pages._product-card', ['product' => $recProduct])
                                </div>
                                @endforeach
                            </div>
                        </div>
                        ...
                        {{--<div class="pointer-events-none absolute right-0 top-0 h-full w-28 bg-gradient-to-r from-transparent to-zinc-100 z-10"></div>
                            <button type="button" data-swiper-target="product-slid-swiper"
                                class="nexo-swiper-next-btn absolute right-11 top-1/2 -translate-y-1/2 z-20 w-10 h-10 bg-white rounded-3xl flex items-center justify-center pointer-events-auto"
...
@push('scripts')
@vite('resources/js/nexo/cart.js')
@endpush
