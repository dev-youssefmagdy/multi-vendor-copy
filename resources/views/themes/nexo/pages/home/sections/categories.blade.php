    ...
    <section wire:ignore class="nexo-cats-section flex flex-col items-center justify-center"
        ...
        {{-- Cards row --}}
        <div class="swiper categories-slide nexo-cats-swiper w-full">
            <div class="swiper-wrapper" style="align-items:stretch;">
                @foreach ($categories as $cat)
                <div class="swiper-slide nexo-cats-slide">
