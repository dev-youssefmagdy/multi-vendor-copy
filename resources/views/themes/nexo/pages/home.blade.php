...
@push('head')
    @vite('resources/css/nexo/home.css')
@endpush
...
{{--                            </svg>--}}
    ...
    @php
        $__homeSections = $homeSections ?? \App\Services\Tenant\PageBuilder\SectionRegistry::defaultsFor('nexo', 'home');
    @endphp
    @foreach ($__homeSections as $__section)
        @includeIf("themes.nexo.pages.home.sections.{$__section}")
    @endforeach
...
@vite('resources/js/nexo/home.js')
@endpush
