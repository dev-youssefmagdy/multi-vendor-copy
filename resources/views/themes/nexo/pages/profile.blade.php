{{--
Nexo – Customer Orders / Profile page
$customer Customer
...
<div class="bg-white">
    ...
    <div id="nexo-profile-drawer-overlay"
        class="fixed inset-0 bg-black/40 z-[900] hidden lg:hidden"
        onclick="nexoProfileDrawerClose()"></div>

    <div id="nexo-profile-drawer"
        ...
        <div class="flex items-center justify-between px-5 py-4 border-b border-[#F0F0F0]">
            ...
            <button type="button" onclick="nexoProfileDrawerClose()"
        ...
        <div class="px-5 py-4 border-b border-[#F0F0F0]">
            ...
            <button wire:click="setTab('profile')" onclick="nexoProfileDrawerClose()"
        ...
        <div class="px-5 py-4 border-b border-[#F0F0F0]">
            ...
            <nav class="flex flex-col gap-0.5">
                <div wire:click="filterStatus(null)" onclick="nexoProfileDrawerClose()"
                ...
                <div wire:click="filterStatus('{{ $val }}')" onclick="nexoProfileDrawerClose()"
        ...
        <div class="px-5 py-4">
            ...
            <nav class="flex flex-col gap-0.5">
                <div wire:click="setTab('profile')" onclick="nexoProfileDrawerClose()"
                    class="sidebar-settings-item">
                    {{ __('My personal details') }}
                </div>
                <div wire:click="setTab('returns')" onclick="nexoProfileDrawerClose()"
                    class="sidebar-settings-item">
                    {{ __('Returns') }}
                </div>
                <div wire:click="logout" onclick="nexoProfileDrawerClose()"
    ...
    <div class="bg-white">
        <div
            ...
            <button id="nexo-profile-menu-btn" type="button"
        ...
        <div class="flex gap-6 lg:gap-8 items-start">
            ...
            <div class="flex-1 min-w-0">
                            ...
                            <div class="border border-[#F0F0F0] rounded-xl p-4">
                                ...
                                <div class="mt-3 flex items-center gap-4">
                                    ...
                                    <a href="{{ route('tenant.storefront.return-detail', $ret->id) }}"
                                        class="text-xs font-medium underline text-main hover:opacity-75">
                                        {{ __('View Details') }}
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="bg-white rounded-[20px] shadow-2xl ring-1 ring-black/5 w-full max-w-lg max-h-[90vh] flex flex-col overflow-hidden">
                            ...
                            <div class="px-6 py-5 space-y-4 overflow-y-auto">
                                ...
                                <div>
                                    ...
                                    @include('themes.nexo.sections.country-select', [
                ...
                <div id="emptyState" class="hidden flex flex-col items-center justify-center py-24 text-center">
                    <img loading="lazy" src="{{ asset('nexo/assets/images/empty-orders.svg') }}" alt="{{ __('broken heart') }}">
...
function nexoProfileDrawerOpen() {
    const drawer = document.getElementById('nexo-profile-drawer');
    const overlay = document.getElementById('nexo-profile-drawer-overlay');
...
function nexoProfileDrawerClose() {
    const drawer = document.getElementById('nexo-profile-drawer');
    const overlay = document.getElementById('nexo-profile-drawer-overlay');
    if (!drawer || !overlay) return;
...
document.addEventListener('DOMContentLoaded', function () {
    const btn = document.getElementById('nexo-profile-menu-btn');
    const drawer = document.getElementById('nexo-profile-drawer');
    if (drawer && document.documentElement.dir === 'rtl') {
        drawer.classList.remove('translate-x-full');
        drawer.classList.add('-translate-x-full');
    }
    if (btn) btn.addEventListener('click', nexoProfileDrawerOpen);
});
</script>
@endpush
