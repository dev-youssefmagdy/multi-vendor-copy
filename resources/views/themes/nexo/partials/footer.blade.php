...
<footer class="text-white" style="background:#111827">
    ...
    <div class="max-w-screen-xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10">
            ...
            <div class="col-span-2 lg:col-span-1 items-center">
                ...
                {{-- Connect with NEXO --}}
                <p class="hidden sm:block text-sm font-semibold text-white mb-3">{{ __('Connect with NEXO') }}</p>
                ...
                <div class="hidden sm:block">
                    ...
                    <div class="flex items-center gap-2 flex-wrap">
                        <img loading="lazy" src="{{ asset('nexo/assets/images/pay-visa.svg') }}" alt="{{ __('Visa') }}"
                            class="h-7 rounded" />
                        <img loading="lazy" src="{{ asset('nexo/assets/images/pay-mastercard.svg') }}" alt="{{ __('Mastercard') }}"
                            class="h-7 rounded" />
                        <img loading="lazy" src="{{ asset('nexo/assets/images/pay-applepay.svg') }}" alt="{{ __('Apple Pay') }}"
                            class="h-7 rounded" />
                        <img loading="lazy" src="{{ asset('nexo/assets/images/pay-fawry.svg') }}" alt="{{ __('Fawry Pay') }}"
                            class="h-7 rounded" />
                    </div>
                </div>
    ...
    <div class="py-3 text-center text-xs sm:text-sm text-white/50" style="background:#323232">
        {{ $footerCopyright ?? (__('Copyright ©') . date('Y') . ' ' . ($storeName ?? 'NEXO') . '. ' . __('All Rights Reserved.')) }}
    </div>
