...
@push('head')
    @vite('resources/css/elora/category.css')
@endpush
...
<main class="grow bg-white pb-14 w-full" style="min-height:calc(100vh - 99px)">
    ...
    <div class="flex w-full">
        ...
        <aside id="mobile-filter-drawer"
            class="elora-filter-section flex flex-col shrink-0 overflow-y-auto w-screen sm:w-[259px] h-screen sm:h-[calc(100vh-108px)] border-e border-e-[#F0F0F0] shadow-xl fixed top-0 lg:sticky sm:top-[108px] p-8 pt-12 pe-6 z-50 bg-white transition-transform -translate-x-full lg:translate-x-0">
        ...
        <div class="flex-1 flex flex-col gap-6 px-4 sm:px-6 pt-[19px] pb-10" style="min-width:0">
            ...
            <div class="sm:hidden -mx-4 px-4 overflow-x-auto cat-circles-row -mb-4">
                <x-elora.category-tabs :category="$category" :keyword="$keyword" :sort="$sort"
            ...
            <div class="flex items-center justify-between gap-3 flex-wrap">
                ...
                <div
                    ...
                    @include('themes.elora.pages._product-card', ['product' => $product])
                    @endforeach
                </div>
                {{-- infinite-scroll sentinel --}}
                <div id="elora-infinite-sentinel"
                    data-slug="{{ $slug }}"
                    data-next-page="2"
                    ...
                    <span id="elora-loading-spinner" class="{{ $products->hasMorePages() ? '' : 'hidden' }} flex items-center gap-2 text-sm text-[#888]">
...
@push('scripts')
@vite('resources/js/elora/category.js')
@endpush
