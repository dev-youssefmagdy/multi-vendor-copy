    ...
    <section class="overflow-hidden" style="background: var(--color-primary)">
      <div
        ...
        class="hidden lg:flex items-center justify-center gap-[40px] px-[56px] py-[13px]"
      >
        <div class="flex items-center gap-[14px]">
          <img
            src="{{ asset('elora-5/assets/icons/icon-feature-truck.svg') }}"
            alt=""
            class="size-[39px]"
          />
          <div class="flex flex-col leading-tight">
            <span class="font-semibold text-[16px] text-white whitespace-nowrap"
              >Free Shipping</span
            >
            <span
              class="font-normal text-[14px] whitespace-nowrap"
              style="color: var(--color-stroke)"
        ...
        <div class="flex items-center gap-[14px]">
          <img
            src="{{ asset('elora-5/assets/icons/icon-feature-headphones.svg') }}"
            alt=""
            class="size-[39px]"
          />
          <div class="flex flex-col leading-tight">
        ...
        <div class="flex items-center gap-[14px]">
          <img
            src="{{ asset('elora-5/assets/icons/icon-feature-bag.svg') }}"
            alt=""
            class="size-[39px]"
          />
          <div class="flex flex-col leading-tight">
        ...
        <div class="flex items-center gap-[14px]">
          <img
            src="{{ asset('elora-5/assets/icons/icon-feature-package.svg') }}"
            alt=""
            class="size-[39px]"
          />
          <div class="flex flex-col leading-tight">
