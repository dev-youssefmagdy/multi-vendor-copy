  ...
  <div class="relative shrink-0 w-full" style="height:57.5%">
    ...
    @if (!empty($p['favData']))
      <button type="button" aria-label="{{ __('Add to favorites') }}" onclick="event.preventDefault(); event.stopPropagation(); eloraHeartToggle(this)"
        ...
        class="fan-heart-btn absolute top-[4.91px] left-[5.89px] lg:top-[7.32px] lg:left-[7.32px] bg-white cursor-pointer shadow-[0_3.93px_3.93px_rgba(0,0,0,0.15)] lg:shadow-[0_4.88px_4.88px_rgba(0,0,0,0.15)] flex items-center justify-center p-[7.86px] lg:p-[9.77px] rounded-full shrink-0 size-[31.43px] lg:size-[39.07px]">
        <img src="{{ asset('elora-5/assets/icons/heart.svg') }}" alt="" class="fan-heart-icon size-[19.64px] lg:size-[24.42px]" />
      </button>
    @else
      <button type="button" aria-label="{{ __('Add to favorites') }}" class="fan-heart-btn absolute top-[4.91px] left-[5.89px] lg:top-[7.32px] lg:left-[7.32px] bg-white cursor-pointer shadow-[0_3.93px_3.93px_rgba(0,0,0,0.15)] lg:shadow-[0_4.88px_4.88px_rgba(0,0,0,0.15)] flex items-center justify-center p-[7.86px] lg:p-[9.77px] rounded-full shrink-0 size-[31.43px] lg:size-[39.07px]">
        <img src="{{ asset('elora-5/assets/icons/heart.svg') }}" alt="" class="fan-heart-icon size-[19.64px] lg:size-[24.42px]" />
      </button>
    @endif
    ...
    @if (!empty($p['isOutOfStock']))
      <div class="fan-cart-btn absolute bottom-[4.91px] right-[5.89px] lg:bottom-[7.32px] lg:right-[7.32px] flex items-center justify-center px-[11.78px] py-[3.93px] lg:px-[14.65px] lg:py-[4.88px] rounded-[15.71px] lg:rounded-[19.53px] shrink-0 w-[55.98px] h-[44.19px] lg:w-[69.59px] lg:h-[54.94px] bg-white shadow opacity-50 cursor-not-allowed">
        <img src="{{ asset('elora-5/assets/icons/icon-cart-card.svg') }}" alt="{{ __('Add to cart') }}" class="fan-cart-icon size-[23.57px] lg:size-[29.3px]" />
      </div>
    @elseif (!empty($p['hasMultipleVariants']))
      <button type="button"
        ...
        class="fan-cart-btn absolute bottom-[4.91px] right-[5.89px] lg:bottom-[7.32px] lg:right-[7.32px] flex items-center justify-center px-[11.78px] py-[3.93px] lg:px-[14.65px] lg:py-[4.88px] rounded-[15.71px] lg:rounded-[19.53px] shrink-0 w-[55.98px] h-[44.19px] lg:w-[69.59px] lg:h-[54.94px] bg-white shadow">
        <img src="{{ asset('elora-5/assets/icons/icon-cart-card.svg') }}" alt="{{ __('Add to cart') }}" class="fan-cart-icon size-[23.57px] lg:size-[29.3px]" />
      </button>
    @else
