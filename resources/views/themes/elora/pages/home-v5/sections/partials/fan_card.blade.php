  ...
  <div class="relative shrink-0 w-full" style="height:57.5%">
    ...
    @elseif (!empty($p['hasMultipleVariants']))
      <button type="button"
        ...
        class="fan-cart-btn absolute bottom-[4.91px] end-[5.89px] lg:bottom-[7.32px] lg:end-[7.32px] flex items-center justify-center px-[11.78px] py-[3.93px] lg:px-[14.65px] lg:py-[4.88px] rounded-[15.71px] lg:rounded-[19.53px] shrink-0 w-[55.98px] h-[44.19px] lg:w-[69.59px] lg:h-[54.94px] bg-white shadow">
        <img src="{{ asset('elora-5/assets/icons/icon-cart-card.svg') }}" alt="{{ __('Add to cart') }}" class="fan-cart-icon size-[23.57px] lg:size-[29.3px]" />
      </button>
    @else
