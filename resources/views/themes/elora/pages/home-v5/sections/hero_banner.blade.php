          ...
          <div class="swiper-slide">
            ...
            >
              ...
              >
                ...
                >
                  <span style="color: var(--color-primary)">Explore</span> New
                  Products
                </h1>
                <button
                  type="button"
            ...
            >
              ...
              >
                <h1
                  class="font-bold text-[24px] lg:text-[64px] leading-[1.05] text-white tracking-[0.5px]"
                >
                  <span style="color: var(--color-primary)">Flash</span> Sale Up
                  To 50%
                </h1>
                <button
                  type="button"
            ...
            >
              ...
              >
                <h1
                  class="font-bold text-[24px] lg:text-[64px] leading-[1.05] text-white tracking-[0.5px]"
                >
                  <span style="color: var(--color-primary)">Best</span> Sellers
                  Are Here
                </h1>
                <button
                  type="button"
