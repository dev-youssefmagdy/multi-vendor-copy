    ...
    >
      <h2 class="font-semibold text-[22px] lg:text-[32px] text-center tracking-[0.5px]" style="color: var(--color-black)">Shop by Category</h2>
      <div class="grid grid-cols-2 lg:flex gap-[10px] lg:gap-[16px] w-full lg:w-auto lg:max-w-[790px]">
        <a href="#" class="shop-cat-tile h-[200px] lg:h-[310px] lg:w-[253px]">
          ...
          <div class="absolute inset-0" style="background: linear-gradient(180deg, rgba(19, 32, 146, 0) 40%, rgba(19, 32, 146, 0.55) 100%);"></div>
          <span class="shop-cat-label text-[16px] lg:text-[20px]">Accessories</span>
        </a>
        <div class="flex flex-col gap-[10px] lg:gap-[16px]">
          <a href="#" class="shop-cat-tile h-[95px] lg:h-[147px] lg:w-[253px]">
            ...
            <span class="shop-cat-label text-[14px] lg:text-[18px]">Fashion</span>
          </a>
          <a href="#" class="shop-cat-tile h-[95px] lg:h-[147px] lg:w-[253px]">
            <img src="{{ asset('elora-5/assets/images/shop-cat-electronics.png') }}" alt="Electronics" />
            <div class="absolute inset-0" style="background: linear-gradient(180deg, rgba(19, 32, 146, 0) 30%, rgba(19, 32, 146, 0.55) 100%);"></div>
            <span class="shop-cat-label text-[14px] lg:text-[18px]">Electronics</span>
          </a>
        </div>
      </div>
      <button
