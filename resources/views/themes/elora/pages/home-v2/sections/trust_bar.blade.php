    ...
    >
      <div
        class="flex items-center gap-[24px] lg:gap-[52px] px-[16px] lg:px-[56px] py-[12px] lg:py-[13px] w-max lg:w-full"
      >
        <div class="flex items-center gap-[12px] lg:gap-[26px] shrink-0">
          ...
          />
          <div
            class="flex flex-col text-[13px] lg:text-[19.6px] tracking-[0.5px] lg:tracking-[0.8px] whitespace-nowrap"
          >
