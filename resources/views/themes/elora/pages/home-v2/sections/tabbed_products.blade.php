{{-- ── Tabbed Products V2 (Flash / Best-selling / New In / Top-rated) ──────────────────── --}}
    ...
    <div class="max-w-screen-xl mx-auto px-3 sm:px-4 lg:px-6">
        ...
        <div class="flex items-center md:justify-center gap-2 mb-4 overflow-x-auto no-scrollbar pb-1">
            <button data-tab="flash" type="button"
                class="cat-pill tabbed-pill active {{ $pillBase }}"
                style="border:1px solid #8A38F5;background:#8A38F5;color:#fff;">
            ...
            <button data-tab="bestselling" type="button"
                class="cat-pill tabbed-pill {{ $pillBase }}"
                style="border:1px solid #8A38F5;color:#8A38F5;">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
