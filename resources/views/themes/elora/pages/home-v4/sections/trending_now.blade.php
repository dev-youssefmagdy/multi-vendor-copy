    @php
      $trendingCards = ($trendingNowProducts ?? collect())->map(function ($product) use ($currentCurrency) {
    ...
    <!-- ============ TRENDING NOW ============ -->
    <section
      class="pattern-trending p-[16px] lg:px-[56px] lg:py-[48px] flex flex-col gap-[12px] lg:gap-[34px] "
      wire:ignore
    >
