@php
  ...
  $trendingProducts4 = [
    ['image' => $PLACEHOLDER_IMG, 'name' => 'Essential Shoes', 'weight' => '250g', 'price' => '$89.00', 'oldPrice' => '$89.00', 'discount' => '20% Off', 'rating' => '4.2 (+850)', 'ordered' => '5 ordered last 30 min', 'progress' => 83],
    ['image' => $PLACEHOLDER_IMG, 'name' => 'Essential Shoes', 'weight' => '250g', 'price' => '$89.00', 'oldPrice' => '$89.00', 'discount' => '20% Off', 'rating' => '4.2 (+850)', 'ordered' => '5 ordered last 30 min', 'progress' => 83],
    ['image' => $PLACEHOLDER_IMG, 'name' => 'Essential Shoes', 'weight' => '250g', 'price' => '$89.00', 'oldPrice' => '$89.00', 'discount' => '20% Off', 'rating' => '4.2 (+850)', 'ordered' => '5 ordered last 30 min', 'progress' => 83],
  ];
@endphp
  ...
  <div class="relative">
    <div class="swiper card-swiper trending-swiper">
      <div class="swiper-wrapper" id="trendingWrapper">
        @foreach ($trendingProducts4 as $product)
          @include('themes.elora.pages.home-v4.sections.partials.trending_card', ['p' => $product])
        @endforeach
      </div>
    </div>
  </div>
