    ...
    <div class="swiper card-swiper categories-swiper min-w-0">
      <div class="swiper-wrapper items-end" id="categoriesWrapper">
        @foreach ($categories->take(8) as $cat)
          ...
          <a
            href="{{ $url }}"
            class="swiper-slide max-lg:!w-[66px] lg:w-full flex flex-col items-center gap-[2px] lg:gap-[3.9px]"
          ...
          >
            ...
            <div class="relative pt-[23px] lg:pt-[44px]">
              ...
              {{-- Orange leaf pill --}}
              <div
                class="w-[66px] h-[37px] lg:w-full lg:h-[71.86px]
