{{-- Expects $p: name, price, oldPrice, discount --}}
<div class="flex gap-[5px] rounded-[10px] overflow-hidden h-full" style="background:var(--color-bg-main)">
  <div class="relative w-[45%] max-h-[148px] shrink-0">
    <img src="{{ asset('elora-2/assets/images/product-placeholder.svg') }}" alt="{{ $p['name'] }}" class="h-full max-h-[148px] w-full object-cover rounded-l-[8px]" />
