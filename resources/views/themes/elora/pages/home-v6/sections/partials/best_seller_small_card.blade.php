{{-- Best Seller composite slide's small card (top-left/top-right of the right column). Expects $p: image, name, badge, badgeBg, badgeColor, weight, weightColor, rating, price, priceColor, oldPrice --}}
