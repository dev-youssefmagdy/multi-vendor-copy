@php
  ...
  $__base = [
    ['badge' => '70% Sold', 'badgeBg' => 'var(--color-accent-yellow)', 'badgeText' => 'var(--color-text-primary)', 'name' => 'Essential Shoes', 'weight' => '250g', 'desc' => 'Premium cotton blend', 'rating' => '4.2 (+850)', 'price' => '$89.00', 'oldPrice' => '$89.00', 'discount' => '20% Off', 'urgency' => 'var(--color-success)'],
    ...
    ['badge' => '70% Sold', 'badgeBg' => 'var(--color-accent-yellow)', 'badgeText' => 'var(--color-text-primary)', 'name' => 'Fleece Hoodie', 'weight' => '220g', 'desc' => 'Premium cotton blend', 'rating' => '4.3 (+710)', 'price' => '$99.00', 'oldPrice' => '$120.00', 'discount' => '18% Off', 'urgency' => 'var(--color-error)'],
    ['badge' => 'New In', 'badgeBg' => 'var(--color-accent-purple)', 'badgeText' => 'var(--color-white)', 'name' => 'Trail Sneakers', 'weight' => '270g', 'desc' => 'Premium cotton blend', 'rating' => '4.4 (+560)', 'price' => '$115.00', 'oldPrice' => null, 'discount' => null, 'urgency' => 'var(--color-success)'],
    ['badge' => '70% Sold', 'badgeBg' => 'var(--color-accent-yellow)', 'badgeText' => 'var(--color-text-primary)', 'name' => 'Cargo Pants', 'weight' => '320g', 'desc' => 'Premium cotton blend', 'rating' => '4.1 (+330)', 'price' => '$82.00', 'oldPrice' => '$98.00', 'discount' => '16% Off', 'urgency' => 'var(--color-error)'],
  ...
  $__newIn = array_map(fn ($p) => array_merge($p, ['image' => $__ph]), $__base);
@endphp
<section class="pattern-newin px-[16px] lg:px-[56px] py-[24px] lg:py-[32px] flex flex-col gap-[16px] lg:gap-[24px] mt-12">
  <div class="flex items-center justify-between">
    <h2 class="font-medium text-[22px] lg:text-[32px]" style="color: var(--color-text-primary)">New In</h2>
    <a href="#" class="text-[14px] lg:text-[24px] tracking-[0.5px]" style="color: var(--color-text-primary)">see all</a>
  </div>
  <div class="relative">
    <div class="swiper card-swiper newin-swiper">
      <div class="swiper-wrapper">
        @foreach ($__newIn as $p)
