  ...
  <div class="flex-1 flex flex-col gap-[5px] lg:gap-[7px] p-[6px] lg:p-[7px] w-full">
    <div class="flex flex-col gap-[3px] lg:gap-[5px] w-full">
      <div class="flex items-center justify-between gap-[2px] w-full">
        ...
        <p class="font-normal text-[11px] lg:text-[15px] tracking-[0.4px] lg:tracking-[0.5px] shrink-0" style="color:#FE3A6A">{{ $p['weight'] ?? '' }}</p>
      </div>
    ...
    <div class="flex items-center gap-[5px] lg:gap-[7px] w-full">
      ...
      <span class="font-medium text-[10px] lg:text-[13px] whitespace-nowrap truncate" style="color:#2AAF2F">{{ __('Delivered by') }} {{ now()->addDays(3)->translatedFormat('d F') }}</span>
    </div>
  </div>
</a>
