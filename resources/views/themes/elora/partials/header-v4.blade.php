<header>
    ...
    >
      ...
      <a href="{{ route('tenant.home') }}">
        <x-storefront-logo :storeName="$storeName" :brand-logo="asset('elora-4/assets/icons/logo-elora.svg')" class="h-[38px] w-auto" />
      </a>
      <form action="{{ route('tenant.storefront.search') }}" method="GET"
        data-autocomplete-url="{{ route('tenant.storefront.search.autocomplete') }}"
        ...
        >
          ...
          <span class="flex flex-col items-center">
            <span
              ...
              class="elora-cart-badge text-white text-[14px] rounded-full w-[30px] h-[16px] flex items-center justify-center {{ ($cartCount ?? 0) > 0 ? '' : 'hidden' }}"
...
>
  ...
  >
    <x-storefront-logo :storeName="$storeName" :brand-logo="asset('elora-4/assets/icons/logo-elora.svg')" class="h-[26px] w-auto" />
    <button
      type="button"
      id="drawerCloseBtn"
  ...
  >
    ...
    <a href="{{ route('tenant.storefront.cart') }}" class="flex items-center gap-[10px]">
      ...
      <span
        ...
        class="elora-cart-badge text-white text-[12px] rounded-full w-[22px] h-[16px] flex items-center justify-center {{ ($cartCount ?? 0) > 0 ? '' : 'hidden' }}"
        style="background: var(--color-brand-orange-bright)"
        >{{ $cartCount ?? 0 }}</span
      >
    </a>
