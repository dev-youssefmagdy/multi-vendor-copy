<footer style="background: var(--color-footer-bg)">
    <div class="px-[24px] lg:px-[56px] py-[40px] lg:py-[46px] flex flex-col lg:flex-row gap-[40px] lg:gap-[120px] max-w-[1440px] mx-auto">
        <div class="flex flex-col gap-[32px] lg:justify-between shrink-0">
            <div class="flex flex-col gap-[32px]">
                <img src="{{ asset('elora-3/assets/icons/logo-elora-white.svg') }}" alt="ELORA" class="h-[32px] w-auto" />
                <div class="flex flex-col gap-[16px]">
                    <p class="font-medium text-[16px] text-white">Connect with ELORA</p>
                    <div class="flex gap-[16px] items-center">
                        <img src="{{ asset('elora-3/assets/icons/social-facebook.svg') }}" alt="Facebook" class="size-[24px]" />
                        <img src="{{ asset('elora-3/assets/icons/social-twitter.svg') }}" alt="Twitter" class="size-[24px]" />
                        <img src="{{ asset('elora-3/assets/icons/social-instagram.svg') }}" alt="Instagram" class="size-[24px]" />
                        <img src="{{ asset('elora-3/assets/icons/social-youtube.svg') }}" alt="YouTube" class="size-[32px]" />
                        <img src="{{ asset('elora-3/assets/icons/social-linkedin.svg') }}" alt="LinkedIn" class="size-[24px]" />
                    </div>
                </div>
            </div>
            <div class="flex flex-col gap-[12px]">
                ...
                <div class="flex gap-[12px]">
                    <img src="{{ asset('elora-3/assets/icons/pay-visa.png') }}" alt="Visa" class="h-[37px] w-[56px] object-cover rounded" />
                    <img src="{{ asset('elora-3/assets/icons/pay-mastercard.png') }}" alt="Mastercard" class="h-[37px] w-[56px] object-cover rounded" />
                    <img src="{{ asset('elora-3/assets/icons/pay-applepay.png') }}" alt="Apple Pay" class="h-[37px] w-[56px] object-cover rounded" />
                    <img src="{{ asset('elora-3/assets/icons/pay-fawry.png') }}" alt="Fawry Pay" class="h-[38px] w-[56px] object-cover rounded" />
                </div>
            </div>
        </div>
    ...
    >
        Copyright &copy;{{ now()->year }} ELORA. All Rights Reserved.
    </div>
</footer>
