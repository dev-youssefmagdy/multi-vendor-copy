        ...
        <div class="flex flex-col gap-[32px]">
          ...
          <div class="flex flex-col gap-[16px]">
            <p class="font-medium text-[16px] text-white">
              Connect with {{ $storeName ?? 'ELORA' }}
            </p>
            <div class="flex gap-[16px] items-center">
              <img
                src="{{ asset('elora-4/assets/icons/social-facebook.svg') }}"
                alt="Facebook"
                class="size-[24px]"
              />
              <img
                src="{{ asset('elora-4/assets/icons/social-twitter.svg') }}"
                alt="Twitter"
                class="size-[24px]"
              />
              <img
                src="{{ asset('elora-4/assets/icons/social-instagram.svg') }}"
                alt="Instagram"
                class="size-[24px]"
              />
              <img
                src="{{ asset('elora-4/assets/icons/social-youtube.svg') }}"
                alt="YouTube"
                class="size-[32px]"
              />
              <img
                src="{{ asset('elora-4/assets/icons/social-linkedin.svg') }}"
                alt="LinkedIn"
                class="size-[24px]"
              />
            </div>
