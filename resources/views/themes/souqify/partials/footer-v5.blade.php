    ...
    <div class="flex flex-col gap-[32px] lg:justify-between shrink-0">
        ...
        <div class="flex flex-col gap-[16px]">
          ...
          <div class="flex gap-[16px] items-center">
            <a href="{{ $socialLinksByIcon->get('facebook')?->url ?? '#' }}" target="_blank" rel="noopener noreferrer">
              <img src="{{ asset('souqify-4/assets/icons/social-facebook.svg') }}" alt="Facebook" class="size-[24px]" />
            </a>
            <a href="{{ $socialLinksByIcon->get('twitter')?->url ?? '#' }}" target="_blank" rel="noopener noreferrer">
              <img src="{{ asset('souqify-4/assets/icons/social-twitter.svg') }}" alt="Twitter" class="size-[24px]" />
            </a>
            <a href="{{ $socialLinksByIcon->get('instagram')?->url ?? '#' }}" target="_blank" rel="noopener noreferrer">
              <img src="{{ asset('souqify-4/assets/icons/social-instagram.svg') }}" alt="Instagram" class="size-[24px]" />
            </a>
            <a href="{{ $socialLinksByIcon->get('youtube')?->url ?? '#' }}" target="_blank" rel="noopener noreferrer">
              <img src="{{ asset('souqify-4/assets/icons/social-youtube.svg') }}" alt="YouTube" class="size-[32px]" />
            </a>
            <a href="{{ $socialLinksByIcon->get('linkedin')?->url ?? '#' }}" target="_blank" rel="noopener noreferrer">
              <img src="{{ asset('souqify-4/assets/icons/social-linkedin.svg') }}" alt="LinkedIn" class="size-[24px]" />
            </a>
          </div>
        </div>
      </div>
      <div class="flex flex-col gap-[12px]">
        ...
        <div class="flex gap-[12px]">
          <img src="{{ asset('souqify-4/assets/icons/pay-visa.png') }}" alt="Visa" class="h-[37px] w-[56px] object-cover rounded" />
          <img src="{{ asset('souqify-4/assets/icons/pay-mastercard.png') }}" alt="Mastercard" class="h-[37px] w-[56px] object-cover rounded" />
          <img src="{{ asset('souqify-4/assets/icons/pay-applepay.png') }}" alt="Apple Pay" class="h-[37px] w-[56px] object-cover rounded" />
          <img src="{{ asset('souqify-4/assets/icons/pay-fawry.png') }}" alt="Fawry Pay" class="h-[38px] w-[56px] object-cover rounded" />
        </div>
      </div>
    </div>
...
<nav class="mobile-tabbar lg:hidden fixed bottom-0 left-0 right-0 z-30 bg-white flex items-center justify-between px-[16px] py-[10px]">
  <a href="{{ route('tenant.home') }}" data-mobile-tab class="mobile-tab {{ request()->routeIs('tenant.home') ? 'is-active-tab' : '' }} flex items-center gap-[6px] px-[16px] py-[10px] rounded-[36px]" style="background:var(--color-primary)">
    <img src="{{ asset('souqify-4/assets/icons/navbtm-home.svg') }}" class="size-[22px]" alt="" />
    <span class="text-white text-[13px] tracking-[0.5px]">{{ __('Home') }}</span>
  </a>
  <a href="{{ route('tenant.storefront.favorites') }}" data-mobile-tab class="mobile-tab flex items-center justify-center"><img src="{{ asset('souqify-4/assets/icons/navbtm-heart.svg') }}" class="size-[26px]" alt="{{ __('Favourite') }}" /></a>
  <a href="{{ route('tenant.storefront.best-selling') }}" data-mobile-tab class="mobile-tab flex items-center justify-center"><img src="{{ asset('souqify-4/assets/icons/navbtm-dashboard.svg') }}" class="size-[26px]" alt="{{ __('Dashboard') }}" /></a>
  @auth('storefront')
    <a href="{{ route('tenant.storefront.profile') }}" data-mobile-tab class="mobile-tab flex items-center justify-center"><img src="{{ asset('souqify-4/assets/icons/navbtm-package.svg') }}" class="size-[26px]" alt="{{ __('Orders') }}" /></a>
    <a href="{{ route('tenant.storefront.profile') }}" data-mobile-tab class="mobile-tab flex items-center justify-center"><img src="{{ asset('souqify-4/assets/icons/navbtm-user.svg') }}" class="size-[26px]" alt="{{ __('Account') }}" /></a>
  @else
    <a href="{{ route('tenant.storefront.login') }}" data-mobile-tab class="mobile-tab flex items-center justify-center"><img src="{{ asset('souqify-4/assets/icons/navbtm-package.svg') }}" class="size-[26px]" alt="{{ __('Orders') }}" /></a>
    <a href="{{ route('tenant.storefront.login') }}" data-mobile-tab class="mobile-tab flex items-center justify-center"><img src="{{ asset('souqify-4/assets/icons/navbtm-user.svg') }}" class="size-[26px]" alt="{{ __('Account') }}" /></a>
  @endauth
</nav>
