@push('body-attrs')data-page="index" data-variant="v5"@endpush
...
{{-- ============================================================
     ...
     ============================================================ --}}
<div class="souqify-v5-root" style="background: var(--color-bg-main)">
    @php
    ...
    @foreach ($__homeSections as $__section)
        @includeIf("themes.souqify.pages.home-v5.sections.{$__section}")
    @endforeach
</div>
