...
@endphp
<!-- ============ RECOMMENDED FOR YOU ============ -->
<section class="bg-white px-[16px] lg:px-[56px] py-[24px] flex flex-col gap-[16px] lg:gap-[24px]">
  <div class="flex items-center justify-between">
    <h2 class="font-medium text-[23px] lg:text-[32px]" style="color:var(--color-text-primary)">{{ __('Recommended For You') }}</h2>
  ...
  <div id="recommendedWrapper" class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-[10px] lg:gap-[16px]">
    @forelse ($__recommendedCards as $p)
      <div class="h-[380px] lg:h-[440px]" wire:key="recommended-v2-{{ $p['id'] }}">
