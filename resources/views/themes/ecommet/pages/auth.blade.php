    ...
    <div class="w-full max-w-md">
        ...
        <div class="flex flex-col gap-3 mb-6">
            <a href="{{ route('tenant.storefront.social.google') }}"
                class="w-full flex items-center justify-center gap-2 border border-[#dcdcdc] rounded-full py-3 text-[13px] font-semibold text-gray-darkest hover:bg-gray-lightest transition">
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <span class="text-[11px] text-gray-medium uppercase tracking-wide">{{ __('or') }}</span>
            <div class="flex-1 h-px bg-[#eee]"></div>
        </div>
