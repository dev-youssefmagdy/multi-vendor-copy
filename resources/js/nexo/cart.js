...
var productSlid = new Swiper(".product-slid-swiper", _nexoSwiperCfg);
var shoppersSlid = new Swiper(".shoppers-slid-swiper", _nexoSwiperCfg);

// Next-arrow buttons for each slider
document.querySelectorAll('.nexo-swiper-next-btn').forEach(function (btn) {
