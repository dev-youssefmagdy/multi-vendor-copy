        ...
        <div class="relative w-full max-w-[550px] bg-white rounded-[12px] p-10 shadow-2xl scale-90 opacity-0 transition-all duration-300 transform" id="shippingContent">
            ...
            <div class="flex flex-col items-center font-main">
                ...
                <div class="w-full text-left space-y-4 mb-10 px-2">
                    ...
                    <div class="flex items-start gap-2.5">
                        <span class="text-[18px] leading-none mt-1.5">•</span>
                        <p class="text-[15px] text-[#242424] font-medium leading-relaxed">Get a $20.00 credit (Standard Shipping) for late delivery.</p>
                    </div>
                    <div class="flex items-start gap-2.5">
                        <span class="text-[18px] leading-none mt-1.5">•</span>
...
document.addEventListener('click', function (e) {
    ...
    if (targetBtn) {
        ...
        // Skip the variant selection modal's confirm button — it has its own
        // dedicated listener that dispatches 'add-to-cart-variant' to Livewire.
        if (targetBtn.id === 'variant-modal-confirm') return;
