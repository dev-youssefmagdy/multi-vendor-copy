...
(function () {
    ...
    function initInfiniteScroll() {
        ...
        var sentinel = document.getElementById('elora-infinite-sentinel');
        var spinner  = document.getElementById('elora-loading-spinner');
        if (!sentinel) return;
        ...
        function loadMore() {
            ...
            fetch(url, { headers: { 'X-Requested-With': 'XMLHttpRequest' } })
                ...
                .then(function (data) {
                    ...
                    var currentSentinel = document.getElementById('elora-infinite-sentinel');
