...
use App\Http\Controllers\Tenant\StorefrontSearchController;
use App\Http\Controllers\Tenant\StorefrontSocialAuthController;
use App\Http\Controllers\Tenant\PaymentController;
use App\Http\Controllers\Tenant\TenantPathController;
...
//
Route::post('/s/{tenant}/livewire/update', [TenantPathController::class, 'livewireUpdate'])
...
Route::prefix('vendor/{tenant}')
    ...
    ->group(function () {
        ...
        Route::get('/', HomePage::class)->middleware('blade.theme.home')->name('tenant.path.home');
        ...
        Route::get('/search/autocomplete', [StorefrontSearchController::class, 'autocompletePath'])->name('tenant.path.storefront.search.autocomplete');

        Route::get('/api/products', [StorefrontSearchController::class, 'productsPath'])->name('tenant.path.storefront.products.json');
        ...
        Route::get('/categories-products/{slug?}', [StorefrontSearchController::class, 'categoryProductsPath'])->name('tenant.path.storefront.category.products.json');
        ...
        Route::post('/account/logout', [StorefrontSocialAuthController::class, 'logoutPath'])
        ...
        Route::get('/admin{any}', [TenantPathController::class, 'adminRedirect'])
