    ...
    protected function processForm(Request $request, ?Language $language, LanguageService $service, OpenAiTranslationService $openAi)
    {
        try {
            $validated = $request->validate([
                ...
                'offers_ai_translation' => ['boolean'],
                'ai_translation_price' => ['nullable', 'numeric', 'min:0', 'required_if:offers_ai_translation,1'],
        ...
        $savedLanguage = $service->save([
            ...
            'ai_translation_price' => ($validated['offers_ai_translation'] ?? false) ? (float) $validated['ai_translation_price'] : null,
