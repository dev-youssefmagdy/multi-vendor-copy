...
return new class extends Migration {
    public function up(): void
    {
        ...
        // (NULL = "Default / All Countries", a central country id — tenant DB has
        // no countries table so no FK) can't join the primary key. Use a surrogate
        // id as PK and a unique index for the natural key instead — MySQL's UNIQUE
        // index (unlike PRIMARY KEY) treats each NULL as distinct, so one default
        // row and any number of per-country rows can coexist.
