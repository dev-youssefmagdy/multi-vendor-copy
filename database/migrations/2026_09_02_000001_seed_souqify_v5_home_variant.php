...
return new class extends Migration
{
    public function up(): void
    {
        HomeVariant::query()->updateOrCreate(
            ['theme_slug' => 'souqify', 'key' => 'v5'],
            [
                'name' => 'Orange Edition',
                'description' => 'Souqify home page based on the souqify-4 orange mockup.',
                ...
                'colors' => null,
                'view' => 'themes.souqify.pages.home-v5',
                'is_default' => false,
                'is_active' => true,
                'preview_image' => null,
            ]
    ...
    {
        HomeVariant::query()->where('theme_slug', 'souqify')->where('key', 'v5')->delete();
    }
};
