...
return new class extends Migration {
    ...
    {
        return [
            'Order Invoice' => 'admin.invoice_issued',
            'Admin Order Alert' => 'admin.order_alert',
            'Shipping Escalation Notice' => 'admin.shipping_escalation',
            'Vendor Wallet Transaction Alert' => 'admin.vendor_wallet_transaction',
            'Tenant Subscription Activated' => 'admin.tenant_subscription_activated',
            'Tenant Subscription Renewal Reminder' => 'admin.tenant_subscription_renewal_reminder',
            'Tenant Subscription Cancelled' => 'admin.tenant_subscription_cancelled',
